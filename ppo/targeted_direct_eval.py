"""Evaluate best-case targeted composition by directly combining known-best PPO policies via GPI."""
...
def run_targeted_direct(
        ...
        for combo in combos:
            ...
            for policy_name in combo:
                ...
                if model_path is None or not os.path.exists(model_path):
                    ...
                    combo_models = []
                    break
                combo_models.append(get_ppo_model(model_path, device))
    ...
    # Write CSV
    output_csv = os.path.join(output_dir, "targeted_direct_ppo_results.csv")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate best-case targeted PPO composition via GPI."
    )
    parser.add_argument(
        "--base-dir",
        type=str,
