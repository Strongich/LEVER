"""
Plot average reward for direct hybrid DQN composition (trivial/double/triple).

Reads hybrid_direct_dqn/hybrid_direct_dqn_results.csv and aggregates
scratch_reward vs direct_hybrid_reward, grouped by type.
"""
...
def plot_average(results_csv: str, output_path: str):
    ...
    ax.set_title("Direct Hybrid (DQN) - Reward")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Plot average direct hybrid DQN results (trivial/double/triple)."
    )
    parser.add_argument(
        "--results-csv",
        type=str,
        default="hybrid_direct_dqn/hybrid_direct_dqn_results.csv",
        help="Path to hybrid_direct_dqn_results.csv",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="hybrid_direct_dqn/average_hybrid_direct_dqn.png",
